        ...
        <div className={styles.centerStripeD2}>
          ...
          <form className={styles.form} onSubmit={handleSubmit}>
            ...
            <input
              ...
              required
            />
            <button className="submit">Zum Gästebuch</button>
          </form>
          <div className={styles.guestFeedback}>
            <h5>
              Bitte mit der Email-Adresse der Einladung anmelden! Passwort der
              Anmeldung...
            </h5>
          </div>
        </div>
...
export default E2D2LoginGuestGuestbook;
